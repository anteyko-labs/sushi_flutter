...
class TwoGisWebMapScreen extends StatefulWidget {
  ...
  @override
  State<TwoGisWebMapScreen> createState() => _TwoGisWebMapScreenState();
}

class _TwoGisWebMapScreenState extends State<TwoGisWebMapScreen> {
  ...
  Widget _buildMapWidget() {
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
            // 2GIS Web Map через iframe
            Container(
              width: double.infinity,
              height: double.infinity,
              child: _build2GisWebMap(),
            ),
  ...
  Widget _build2GisWebMap() {
    // Для Web используем 2GIS Web API через iframe
    if (kIsWeb) {
      return Container(
        width: double.infinity,
        height: double.infinity,
